...
/**
 * PUBLIC_INTERFACE
 * Spinner with improved contrast to fit Ocean Professional theme.
 */
export const Spinner: React.FC<SpinnerProps> = ({
  ...
  return (
    <div className={cx('inline-flex items-center', className)} role="status" aria-live="polite" aria-busy="true">
      <svg className="animate-spin" width={dim} height={dim} viewBox="0 0 24 24" aria-hidden="true">
        <circle cx="12" cy="12" r="10" stroke="#E5E7EB" strokeWidth="4" fill="none" />
        <path d="M4 12a8 8 0 018-8" stroke={colorValue} strokeWidth="4" strokeLinecap="round" />
      </svg>
